...
def preprocess(args):
    ...
    for train_indices, test_indices in zip(train_idxs.values(), test_idxs.values()):
        all_trainsets.append(BloodMNISTDataset([train_dataset[i] for i in train_indices]))
        all_testsets.append(BloodMNISTDataset([test_dataset[i] for i in test_indices]))
