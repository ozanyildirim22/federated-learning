...
if __name__ == "__main__":
    ...
    if args.cuda and not torch.cuda.is_available():
        print("\033[1;31mCUDA requested but not available. Falling back to CPU.\033[0m")
    ...
    if use_cuda:
        print("\033[1;32mUsing device: CUDA\033[0m")
    else:
        print("\033[1;32mUsing device: CPU\033[0m")
